...
export default function Container(){
    ...
    async function handleFetch(props){
        ...
        const url = `https://mahadevan.herokuapp.com/api/getbdetail/${router.query.id}`
    ...
    return (
        <Layout>
            ...
            <div>
                {   
                    data.bdetails.map((item)=>{
                        const url=`https://mahadevan.herokuapp.com/assets/bdetail/${data.images}/image${item.id}.svg`;
                        return(
